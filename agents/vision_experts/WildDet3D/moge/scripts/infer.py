...
@click.option('--input', '-i', 'input_path',default = "./example_images/2037.jpg", type=click.Path(exists=True), help='Input image or folder path. "jpg" and "png" are supported.')
...
@click.option('--pretrained', 'pretrained_model_name_or_path',default = "./model.pt", type=str, help='Pretrained model name or path. If not provided, the corresponding default model will be chosen.')
